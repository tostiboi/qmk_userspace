 ...
 */
    [Base] = LAYOUT(
     KC_ESC, LT(7,KC_QUOTE), KC_U,         KC_O,         KC_P,         KC_Y,                                                     KC_X,         KC_C,         KC_L,         KC_B,         KC_V,         KC_NO,
     KC_ESC, LGUI_T(KC_A), LALT_T(KC_I), LCTL_T(KC_E), LSFT_T(KC_N), KC_H,                                                     KC_M,         LSFT_T(KC_D), LCTL_T(KC_R), LALT_T(KC_T), LGUI_T(KC_S), KC_NO,
     KC_ESC, KC_SLSH,      LT(0,KC_DOT),LT(0,KC_COMMA),LT(0,KC_K),   KC_Q,         KC_NO, LT(7,KC_ESC), LT(7,KC_ESC), KC_NO,          KC_F,         KC_G,         KC_W,         KC_J,         KC_Z,         KC_NO,
